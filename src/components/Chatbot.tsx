            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-6 right-6 z-50 w-[calc(100vw-3rem)] sm:w-[400px] h-[550px] max-h-[70vh] flex flex-col rounded-2xl overflow-hidden bg-[#0a0b10]/80 border border-cyan-500/30 backdrop-blur-xl shadow-[0_0_30px_rgba(0,242,255,0.15)]"
                    >
                        {/* Header */}
