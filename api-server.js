...
const openai = new OpenAI({
    apiKey: process.env.OPENAI_API_KEY || process.env.VITE_OPENAI_API_KEY || "", // Fallbacks to prevent crash during instantiation if undefined
});
...
app.post('/api/chat', async (req, res) => {
    try {
        ...
        const ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress || 'anonymous-user';
